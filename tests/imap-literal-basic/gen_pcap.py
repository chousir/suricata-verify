#!/usr/bin/env python3
"""Generate input.pcap for imap-literal-basic.

A single FETCH response whose declared {n} literal size matches the real
body length exactly - the baseline case for the literal byte-count fix.
"""
